...
const INTENCOES = ['previsao_entrega', 'laudo_disponivel', 'status_exame', 'orientacao_preparo', 'outro'];
...
- outro: qualquer outro assunto (convênio, orçamento, dúvida geral, saudação, etc.).
